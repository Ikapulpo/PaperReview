...
使用例:
  ── 週刊NKT ──
  paper-review run                    NKT論文レビュー実行
  paper-review run --days 14          過去14日間のNKT論文を検索
  paper-review search                 NKT PubMed検索のみ
  paper-review schedule               NKT週次スケジューラ起動
  paper-review verify                 NKT Notion接続テスト

  ── 週刊スパイン ──
  paper-review spine run              脊椎論文レビュー実行
  paper-review spine run --days 14    過去14日間の脊椎論文を検索
  paper-review spine search           脊椎 PubMed検索のみ
  paper-review spine verify           スパイン Notion接続テスト
""",
    )
    ...
    p_schedule = subparsers.add_parser("schedule", help="週次スケジューラ起動")
    ...
    p_spine_search = spine_sub.add_parser("search", help="脊椎 PubMed検索のみ")
    ...
    p_spine_verify = spine_sub.add_parser("verify", help="スパイン Notion接続テスト")
