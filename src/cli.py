...
def main():
    parser = argparse.ArgumentParser(
        description="論文レビューシステム（週刊NKT + 週刊スパイン）",
...
使用例:
  ...
  paper-review schedule-all             NKT+Spine 両方のスケジューラを起動
""",
    )
    ...
    # ── Combined scheduler ──
    p_all = subparsers.add_parser("schedule-all", help="NKT+Spine 両方のスケジューラを起動")
