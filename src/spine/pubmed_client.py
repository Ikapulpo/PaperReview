...
SPINE_JOURNAL_QUERY = (
    ...
    "OR ("
    '("The Journal of bone and joint surgery. American volume"[Journal] OR '
    '"The Journal of bone and joint surgery"[Journal]) '
    'AND ("spine" OR "spinal" OR "lumbar" OR "cervical" OR "thoracic" OR '
    '"vertebra" OR "vertebral" OR "disc" OR "disk" OR "scoliosis" OR '
    '"stenosis" OR "fusion" OR "laminectomy" OR "discectomy" OR '
    '"kyphosis" OR "lordosis" OR "myelopathy" OR "radiculopathy")'
    ")"
)
...
class SpinePubMedClient:
    """PubMed client specialised for spine journal searches."""
